            ...
            <div class="card card-body bg-light">
                ...
                <form action="<?php echo URLROOT; ?>/users/register" method="post">
                    <div class="form-group mb-3">
                        <label class="mb-1" for="name">Name: <sup>*</sup></label>
                    ...
                    <div class="form-group mb-3">
                        <label class="mb-1" for="confirm_password">Confirm password: <sup>*</sup></label>
                        <input type="password" name="confirm_password" class="form-control form-control-lg <?php echo ( !empty( $data['confirm_password_err'] ) ) ? 'is-invalid' : ''; ?>" value="<?php echo $data['email'] ?>">
